...
@Component({
  ...
  templateUrl: './item-utilities.component.html',
  styleUrls: ['./item-utilities.component.scss']
})
export class ItemUtilitiesComponent implements OnInit {
  ...
  constructor(private modalService: NgbModal, private fb: FormBuilder, private  utilitieService: UtilitieService) {
  }
